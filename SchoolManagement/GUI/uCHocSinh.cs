...
namespace SchoolManagement.GUI
{
    public partial class uCHocSinh : UserControl
    {
        ...
        {
            hocSinhDTO stu = new hocSinhDTO(txtMaHS.Text, txtTenHS.Text, cbbGT.Text, dtpNgaySinh.Text, txtMaLp.Text, txtDT.Text, txtDC.Text);
        ...
        private void dGV_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtMaLp.Text = dGV.Rows[i].Cells[4].Value.ToString();
        ...
        private void btnTimKiem_Click(object sender, EventArgs e)
        {
            ...
            else if (cboTimkiem.Text == "Mã Lớp") searchType = "Class";
